...
const SecondPage = () => (
  <Layout>
    ...
    1UPVC reserves the right to ask for proof of age and to withhold or terminate your use of the Website if you are below the speciﬁed age requirement.</p>
    ...
    (3)	access, tamper with or use non-public areas or parts of the Website, or shared areas of the Website that 1UPVC has not invited you to access;
    ...
    (6)	take action that imposes an unreasonable load on our infrastructure or that of our third party providers (where 1UPVC reserves the right to determine what is reasonable or unreasonable).
  ...
  <p>
    ...
    You may report violations of these guidelines directly to 1UPVC by emailing legal@1UPVC.com.
    </p>
    ...
    <h3>The Website</h3>
    <p>
    The Website and its entire contents, features and functionality (including but not limited to all information, software, text, displays, images, video, audio and the design, selection and arrangement thereof) are owned by 1UPVC, its licensors or other providers of such material and are protected by United States and international copyright, trademark, patent, trade secret and other intellectual property or proprietary rights laws.
    ...
    If you wish to make any use of material on the Website other than that set out in this section, please address your request to: legal@1upvc.com.

    If you print, copy, modify, download, or otherwise use or provide any other person with access to any part of the Website in breach of these Terms, your right to use the Website will stop immediately and you must, at our option, return or destroy any copies of the materials you have made. No right, title, or interest in or to the Website or any content on the Website is transferred to you, and all rights not expressly granted are reserved by 1UPVC. Any use of the Website not expressly permitted by these Terms is a breach of these Terms and may violate copyright, trademark, and other laws.
    </p>
    <h3>Trademarks</h3>
    <p>
    The 1UPVC name; the Terms “1UPVC”; the 1UPVC logo; and all related names, logos, product and service names, designs, and slogans are trademarks of 1UPVC, its affiliates or its licensors. You must not use such marks without 1UPVC’s prior written permission. All other names, logos, product and service names, designs, and slogans on this Website are the trademarks of their respective owners. You must not use such marks without the prior written permission of their respective owners.
    </p>
    <h3>Feedback</h3>
    <p>
    To the extent that you give us feedback, comments, or suggestions concerning the Website (collectively, “Feedback”), you acknowledge and agree that all Feedback is 1UPVC’s sole and exclusive property. You agree to irrevocably assign and transfer to us, and hereby do assign and transfer to us all of your right, title, and interest in and to the Feedback, including all intellectual property rights therein. To the extent that the foregoing assignment is ineffective for whatever reason, you agree to grant and hereby grant to 1UPVC a non-exclusive, perpetual, irrevocable, royalty free, worldwide license (with the right to grant and authorize sublicenses) to make, have made, use, import, offer for sale, sell, reproduce, distribute, modify, adapt, prepare derivative works of, display, perform and otherwise exploit such Feedback without restriction. At our request and expense, you will execute documents and take such further acts as we may reasonably request to assist us in acquiring, perfecting and maintaining our intellectual property rights in and other legal protections for the Feedback.
    </p>
    ...
    <h2>Termination; Reservation of Rights</h2>
      <p>
        ...
        Any future release, update or other addition to the Website shall be subject to this Agreement. 1UPVC reserves all rights not explicitly granted in this Agreement.

        All sections of this Agreement that by their nature should survive termination shall survive termination, including without limitation: 1UPVC’s Intellectual Property, Warranty Disclaimers, Limitation of Liability, Indemnification, Dispute Resolution and Additional Terms.
      </p>


    <h2>Disclaimer of Warranty</h2>
    <p>
    THE WEBSITE AND ITS CONTENT ARE PROVIDED ON AN "AS IS", "AS AVAILABLE" AND "WITH ALL FAULTS" BASIS. TO THE FULLEST EXTENT PERMISSIBLE BY LAW, NEITHER 1UPVC NOR ANY OF ITS EMPLOYEES, MANAGERS, OFFICERS, DIRECTORS OR AGENTS (COLLECTIVELY, THE "1UPVC PARTIES") MAKE ANY REPRESENTATIONS OR WARRANTIES OR ENDORSEMENTS OF ANY KIND WHATSOEVER, EXPRESS OR IMPLIED, AS TO: (1) THE WEBSITE; (2) THE CONTENT OF THE WEBSITE; (3) ANY PRODUCTS OR SERVICES OFFERED ON THE WEBSITE; OR (4) SECURITY ASSOCIATED WITH THE TRANSMISSION OF INFORMATION TO 1UPVC OR VIA THE WEBSITE. IN ADDITION, THE 1UPVC PARTIES HEREBY DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, THE WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, NON-INFRINGEMENT, TITLE, CUSTOM, TRADE, QUIET ENJOYMENT, SYSTEM INTEGRATION AND FREEDOM FROM COMPUTER VIRUS.

    THE 1UPVC PARTIES DO NOT REPRESENT OR WARRANT THAT THE WEBSITE WILL BE ERROR-FREE; THAT ACCESS TO THE WEBSITE WILL BE UNINTERRUPTED; THAT DEFECTS WILL BE CORRECTED; OR THAT THE WEBSITE OR THE SERVER THAT MAKES THE WEBSITE AVAILABLE IS FREE FROM ANY HARMFUL COMPONENTS, INCLUDING, WITHOUT LIMITATION, VIRUSES.

    THE INFORMATION PRESENTED ON OR THROUGH THE WEBSITE IS MADE AVAILABLE SOLELY FOR GENERAL INFORMATION PURPOSES. THE 1UPVC PARTIES DO NOT MAKE ANY REPRESENTATIONS OR WARRANTIES THAT THE INFORMATION ON THE WEBSITE (INCLUDING ANY INSTRUCTIONS) IS ACCURATE, COMPLETE, OR USEFUL. YOU ACKNOWLEDGE THAT YOUR USE OF THE WEBSITE AND RELIANCE ON ANY INFORMATION CONTAINED THEREIN ARE AT YOUR SOLE RISK. THE 1UPVC PARTIES DO NOT WARRANT THAT YOUR USE OF THE WEBSITE IS LAWFUL IN ANY PARTICULAR JURISDICTION, AND THE 1UPVC PARTIES SPECIFICALLY DISCLAIM SUCH WARRANTIES.
    ...
    THE 1UPVC PARTIES DO NOT ENDORSE CONTENT AND SPECIFICALLY DISCLAIM ANY RESPONSIBILITY OR LIABILITY TO ANY PERSON OR ENTITY FOR ANY LOSS, DAMAGE (WHETHER ACTUAL, CONSEQUENTIAL, PUNITIVE OR OTHERWISE), INJURY, CLAIM, LIABILITY OR OTHER CAUSE OF ANY KIND OR CHARACTER BASED UPON OR RESULTING FROM ANY CONTENT.
    </p>

    <h2>Limitation of Liability; Waiver; Release</h2>
    <p>
    TO THE FULLEST EXTENT PROVIDED BY LAW, IN NO EVENT WILL 1UPVC, ITS AFFILIATES, OR ITS AND THEIR LICENSORS, SERVICE PROVIDERS, EMPLOYEES, AGENTS, OFFICERS, OR DIRECTORS BE LIABLE FOR DAMAGES OF ANY KIND, UNDER ANY LEGAL THEORY, ARISING OUT OF OR IN CONNECTION WITH YOUR USE, OR INABILITY TO USE, THE WEBSITE, ANY WEBSITES LINKED TO IT OR ANY CONTENT ON THE WEBSITE OR SUCH LINKED WEBSITES, INCLUDING ANY DIRECT, INDIRECT, SPECIAL, INCIDENTAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO, PERSONAL INJURY, PAIN AND SUFFERING, EMOTIONAL DISTRESS, LOSS OF REVENUE, LOSS OF PROFITS, LOSS OF BUSINESS OR ANTICIPATED SAVINGS, LOSS OF USE, LOSS OF GOODWILL, LOSS OF DATA, AND WHETHER CAUSED BY TORT (INCLUDING NEGLIGENCE), BREACH OF CONTRACT, OR OTHERWISE, EVEN IF FORESEEABLE.

    THE FOREGOING DOES NOT AFFECT ANY LIABILITY THAT CANNOT BE EXCLUDED OR LIMITED UNDER APPLICABLE LAW.

    YOU AGREE THAT IN THE EVENT YOU INCUR ANY DAMAGES, LOSSES OR INJURIES THAT ARISE OUT OF 1UPVC’S ACTS OR OMISSIONS, THE DAMAGES, IF ANY, CAUSED TO YOU ARE NOT IRREPARABLE OR SUFFICIENT TO ENTITLE YOU TO AN INJUNCTION PREVENTING ANY EXPLOITATION OF ANY WEBSITE, SERVICE, PROPERTY, PRODUCT OR OTHER CONTENT OWNED OR CONTROLLED BY THE 1UPVC PARTIES, AND YOU WILL HAVE NO RIGHTS TO ENJOIN OR RESTRAIN THE DEVELOPMENT, PRODUCTION, DISTRIBUTION, ADVERTISING, EXHIBITION OR EXPLOITATION OF ANY WEBSITE, PROPERTY, PRODUCT, SERVICE, OR OTHER CONTENT OWNED OR CONTROLLED BY THE 1UPVC PARTIES.

    BY ACCESSING THE SERVICE, YOU UNDERSTAND THAT YOU MAY BE WAIVING RIGHTS WITH RESPECT TO CLAIMS THAT ARE AT THIS TIME UNKNOWN OR UNSUSPECTED, AND IN ACCORDANCE WITH SUCH WAIVER, YOU ACKNOWLEDGE THAT YOU HAVE READ AND UNDERSTAND, AND HEREBY EXPRESSLY WAIVE, THE BENEFITS OF SECTION 1542 OF THE CIVIL CODE OF CALIFORNIA, AND ANY SIMILAR LAW OF ANY STATE OR TERRITORY, WHICH PROVIDES AS FOLLOWS: "A GENERAL RELEASE DOES NOT EXTEND TO CLAIMS WHICH THE CREDITOR DOES NOT KNOW OR SUSPECT TO EXIST IN HIS FAVOR AT THE TIME OF EXECUTING THE RELEASE, WHICH IF KNOWN BY HIM MUST HAVE MATERIALLY AFFECTED HIS SETTLEMENT WITH THE DEBTOR."

    1UPVC IS NOT RESPONSIBLE FOR THE ACTIONS, CONTENT, INFORMATION, OR DATA OF THIRD PARTIES, AND YOU RELEASE US, OUR DIRECTORS, OFFICERS, EMPLOYEES, AND AGENTS FROM ANY CLAIMS AND DAMAGES, KNOWN AND UNKNOWN, ARISING OUT OF OR IN ANY WAY CONNECTED WITH ANY CLAIM YOU HAVE AGAINST ANY SUCH THIRD PARTIES.
    </p>

    <h2>Indemnification</h2>
    <p>
    You agree to defend (at 1UPVC's request), indemnify and hold harmless 1UPVC, its affiliates, licensors, and service providers, and its and their respective officers, directors, employees, contractors, agents, licensors, suppliers, successors, and assigns from and against any claims, liabilities, damages, losses, and expenses, including without limitation, reasonable attorney's fees and costs, arising out of or in any way connected with your violation of these Terms or your use of the Website. You shall cooperate as fully as required by 1UPVC in the defense of any such claim. 1UPVC reserves the right to assume the exclusive defense and control of any matter subject to indemnification by you, and you will not in any event settle any claim without the prior written consent of 1UPVC.
    </p>

    <h2>Time Limitation of Claims</h2>
    <p>
    You agree that any claim you may have arising out of or related to your relationship with 1UPVC must be filed within one (1) year after you first know, or reasonably should have known of the act, omission or default giving rise to the claim; otherwise, your claim is permanently barred. If applicable law prohibits a one (1) year limitation, any claim must be asserted within the shortest time period permitted by applicable law.
    </p>
    <h2>Additional Terms</h2>
    <h3>Entire Agreement</h3>
    <p>
    This Agreement, which includes these Terms and the Privacy Policy, constitutes the sole and entire agreement between you and 1UPVC regarding the Website and supersedes all prior and contemporaneous understandings, agreements, representations, and warranties, both written and oral, regarding the Website.
    </p>
    ...
    To give us notice under these Terms, you must contact us as follows: (i) by writing to legal@1upvc.com; or (ii) by personal delivery, overnight courier, or registered or certified mail to:
    ...
    <h3>Assignment</h3>
    <p>
    You may not assign this Agreement or assign any rights or delegate any obligations hereunder, in whole or in part, whether voluntarily or by operation of law, without the prior written consent of 1UPVC. Any purported assignment or delegation by you without the appropriate prior written consent of 1UPVC will be null and void. 1UPVC may assign this Agreement or any rights hereunder without your consent. Neither the course of conduct between the parties nor trade practice will act to modify this Agreement.
    </p>

    <h3>Waiver and Severability</h3>
    <p>
    No waiver by 1UPVC of any term or condition set out in this Agreement shall be deemed a further or continuing waiver of such term or condition or a waiver of any other term or condition, and any failure of 1UPVC to assert a right or provision under this Agreement shall not constitute a waiver of such right or provision.
    ...
    <h3>Events Beyond 1UPVC’s Control</h3>
    <p>
    ...
    <p>
    If there is any dispute arising out of the Website, by using the Website, you expressly agree that any such dispute shall be governed by the laws of the State of Virginia, without giving effect to its conﬂict of laws principles. You acknowledge and agree that any violation of this Agreement may cause 1UPVC irreparable harm, and therefore agree that 1UPVC will be entitled to seek extraordinary relief in court, including but not limited to temporary restraining orders, preliminary injunctions and permanent injunctions without the necessity of posting a bond or other security, in addition to and without prejudice to any other rights or remedies that 1UPVC may have for a breach of this Agreement.
    </p>
    <h3>Translation</h3>
    <p>
